...
// Utilisé par montre.html (fiches) et collection.html (filtres)
// ============================================================

const MARQUES = [
  { nom: 'Rolex', domaine: 'rolex.com' },
  { nom: 'Patek Philippe', domaine: 'patek.com' },
  { nom: 'Audemars Piguet', domaine: 'audemarspiguet.com' },
  { nom: 'Omega', domaine: 'omegawatches.com' },
  { nom: 'Cartier', domaine: 'cartier.com' },
  { nom: 'Tudor', domaine: 'tudorwatch.com' },
  { nom: 'IWC Schaffhausen', domaine: 'iwc.com' },
  { nom: 'Jaeger-LeCoultre', domaine: 'jaeger-lecoultre.com' },
  { nom: 'Vacheron Constantin', domaine: 'vacheron-constantin.com' },
  { nom: 'A. Lange & Söhne', domaine: 'alange-soehne.com' },
  { nom: 'Breitling', domaine: 'breitling.com' },
  { nom: 'Hublot', domaine: 'hublot.com' },
  { nom: 'Richard Mille', domaine: 'richardmille.com' },
  { nom: 'Panerai', domaine: 'panerai.com' },
  { nom: 'Longines', domaine: 'longines.com' },
];
...
const MONTRES = {
  'daytona': {
    ...
    set: ['Boîte et écrin d’origine', 'Carte de garantie datée de 2021', 'Maillons et documentation complets', 'Provenance européenne documentée']
  },
  'submariner': {
    marque: 'Rolex',
    nom: 'Submariner Date',
    ...
    set: ['Boîte et écrin d’origine', 'Carte de garantie datée de 2022 — garantie en cours', 'Tous maillons et documentation', 'Première main, achetée en boutique']
  },
  'royal-oak': {
    ...
    set: ['Boîte et écrin d’origine', 'Papiers de la manufacture', 'Historique d’entretien disponible', 'Provenance suisse']
  },
  'explorer': {
    marque: 'Rolex',
    nom: 'Explorer',
    ...
    set: ['Boîte et écrin d’origine', 'Carte de garantie datée de 2021', 'Documentation complète', 'Première main']
  },
  'planet-ocean': {
    marque: 'Omega',
    ...
    set: ['Boîte et écrin d’origine', 'Carte de garantie', 'Facture de révision', 'Provenance française']
  },
  'datejust': {
    marque: 'Rolex',
    nom: 'Datejust 36',
    ...
    set: ['Boîte et écrin d’origine', 'Carte de garantie datée de 2020', 'Maillons complets', 'Provenance européenne documentée']
  },
  'sea-dweller': {
    marque: 'Rolex',
    nom: 'Sea-Dweller',
    ...
    set: ['Boîte et écrin d’origine', 'Carte de garantie datée de 2019', 'Maillons et documentation complets', 'Provenance européenne']
  },
  'planet-ocean-600m': {
    marque: 'Omega',
    ...
    set: ['Boîte et écrin d’origine', 'Carte de garantie', 'Documentation complète', 'Provenance française']
  },
  'portugieser': {
    ...
    set: ['Boîte et écrin d’origine', 'Papiers de la manufacture', 'Facture de révision IWC', 'Provenance suisse']
  },
  'air-king': {
    marque: 'Rolex',
    nom: 'Air-King',
    ...
    set: ['Boîte d’origine', 'Documentation d’époque', 'Révision récente attestée', 'Provenance française']
  }
};
